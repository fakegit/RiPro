    ...
    function cao_widget_pay($args, $instance)
    {
        ...
        if ($cao_vip_rate != 1) {
            ...
            if ($CaoUser->vip_status()) {
                ...
                echo '<div class="pay--rateinfo">';
                echo '<b>' . $vip_price_rate_str . '</b><b class="desc"><a href="'.esc_url(home_url('/user?action=vip')).'" class="type_icont_2">开通' . $site_vip_name . '特权</a></b>';
                echo '</div>';
            }
        }
        ...
        if (!is_user_logged_in()) {
            ...
            // click.
            echo '<button type="button" class="click-pay btn btn--primary btn--block" data-postid="' . $post_id . '" data-nonce="' . $create_nonce . '" data-price="' . $cao_this_am . '"><i class="fa fa-money"></i> 立即购买</button>';
        }
        // 自定义按钮、
