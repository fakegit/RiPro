...
<div class="col-xs-12 col-sm-12 col-md-9">
    ...
    <form class="mb-0">
                        ...
                        <div class="col-md-12">
                            <div class="charge">
                                ...
                                <div class="modules__content">
                                    <?php if (_cao('is_alipay') || _cao('is_weixinpay') || _cao('is_payjs') || _cao('is_xunhupay')) : $cdk_display = 'style="display: none;"';?>
                                    <div id="yuecz">
                                        ...
                                        <div class="custom_amount">
                                            <div class="form-group">
                                                <div class="input-group charge-form">
                                                    <input type="number" name="charge_num" id="charge_num" class="form-control" placeholder="输入整数">
        ...
        <!-- 付款选项 -->
        <?php if (_cao('is_alipay') || _cao('is_weixinpay') || _cao('is_payjs') || _cao('is_xunhupay')) : ?>
        <div class="form-box">
